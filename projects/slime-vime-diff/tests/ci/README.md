...
https://github.com/THUDM/vime/settings/secrets/actions
...
The token can be found at https://github.com/THUDM/vime/settings/actions/runners/new?arch=x64&os=linux.
