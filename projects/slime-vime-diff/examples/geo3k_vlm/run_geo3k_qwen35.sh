...
VLLM_ARGS=(
   ...
   --vllm-ep-size 8
   --vllm-cuda-graph-bs 1 2 4 8 16 24 32 40 48 56 64 72 80 88 96 104 112 120 128 136 144 152 160 168 176 184 192 200 208 216 224 232 240 248 256

   # MTP speculative decoding
   --vllm-speculative-algorithm EAGLE
   --vllm-speculative-num-steps 2
   --vllm-speculative-eagle-topk 1
   --vllm-speculative-num-draft-tokens 3
