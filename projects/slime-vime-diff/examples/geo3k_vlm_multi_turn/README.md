...
- `examples/geo3k_vlm_multi_turn/rollout.py`: custom multi-turn rollout that calls vLLM for token generation, builds loss masks/log_probs, enforces max_turns, and early-stops on max_new_tokens.
