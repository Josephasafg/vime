...
> NOTE: `strands-vllm` is under rapid development, so we recommend using the GitHub repo version: `strands-vllm @ git+https://github.com/horizon-rl/strands-vllm.git`
