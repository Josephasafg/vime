...
def load_slime_arguments_module(monkeypatch):
    ...
    vllm_arguments_mod = types.ModuleType("slime.backends.vllm_utils.arguments")
    vllm_external_mod = types.ModuleType("slime.backends.vllm_utils.external")
    ...
    monkeypatch.setitem(sys.modules, "slime.backends.vllm_utils.arguments", vllm_arguments_mod)
    monkeypatch.setitem(sys.modules, "slime.backends.vllm_utils.external", vllm_external_mod)
