...
| --------------- | ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| Vime           | v0.2.2                                   | [GitHub](https://github.com/THUDM/vime/tree/v0.2.2)                                                                |
| vLLM          | dce8b0606c06d3a191a24c7b8cbe8e238ab316c9 | [GitHub](https://github.com/sgl-project/vllm/tree/vllm-vime)                                             |
...
```shell
cd <WORKSPACE>
git clone https://github.com/sgl-project/vllm.git && cd vllm
...
cd <WORKSPACE>/vllm
git apply ../vime/docker/patch/v0.5.7/vllm.patch
git apply ../npu_patch/vllm.patch
